...
<nav
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			role="button" data-toggle="dropdown" aria-haspopup="true"
			aria-expanded="false"> 
			<span class="mr-2 d-none d-lg-inline text-gray-600 small">Xin chào, ${USERMODEL.fullName}</span>
		</a> <!-- Dropdown - User Information -->
		</li>
		<div class="topbar-divider d-none d-sm-block"></div>
		<li class="nav-item no-arrow">
			<span class="mr-2 d-none d-lg-inline text-gray-600 small"><a class="nav-link"  href='<c:url value="/thoat?action=logout"/>' > <i
