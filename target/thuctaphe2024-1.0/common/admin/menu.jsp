...
<ul
	...
	<!-- Nav Item - Dashboard -->
	<li class="nav-item active"><a class="nav-link" href='<c:url value="/admin-news?type=list&page=1&maxPageItem=2&sortName=title&sortBy=desc"/>'>
			<i class="fas fa-fw fa-tachometer-alt"></i> <span>Quản lý bài viết</span>
	</a></li>
